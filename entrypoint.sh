...
export TABLES_QQ="${TABLES_QQ:-true}"
export TABLES_JD="${TABLES_JD:-true}"
export TABLES_SF="${TABLES_SF:-false}"
export TABLES_WB="${TABLES_WB:-false}"
export HTTP_HOST="${HTTP_HOST:-0.0.0.0}"
export HTTP_PORT="${HTTP_PORT:-8080}"
export MASK_ENABLED="${MASK_ENABLED:-true}"
